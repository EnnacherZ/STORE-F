...
import { getDiscountedPrice as calcDiscountedPrice, getLineTotal as calcLineTotal } from '../utils/pricing';
...
const Cart: React.FC = () => {
  ...
  const { currencies, payment } = useStoreConfig();
  const {
    cartTotalAmount,
    cartChecker,
    allItems,
  ...
  const getLineTotal = (price: number, promo: number, quantity: number) =>
    calcLineTotal(price, promo, quantity).toFixed(2);
          ...
          <div className="currency-bar">
            <div className="currency-bar__selector">
              ...
              <ReactCountryFlag
                ...
                countryCode={currencies.getCountryCodeByCurrency(currentCurrency)}
                svg
          ...
          <div className="order-summary card shadow">
            ...
            <div className="payment-logos">
              <div className="payment-logos__grid">
                {payment.acceptedCardLogos.map(({ src, name }) => (
