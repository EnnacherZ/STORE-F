...
const Footer: React.FC = () => {
  ...
  const { logo, legalName: STORE_LEGAL_NAME, contact: STORE_CONTACT, socials: STORE_SOCIALS } = useStoreConfig();
      ...
      <div className="footer-inner">
        ...
        <div className="footer-brand">
          <div className="iconStoreWDiv">
            <img src={logo.white} alt={STORE_LEGAL_NAME} />
          </div>
        ...
        <div className="footer-col">
          ...
          <div style={{ fontSize: 14 }}>
            <p>
              {t("form.phone.label")} :{" "}
              <a href={STORE_CONTACT.phoneHref} className="socialLinks">
                {STORE_CONTACT.phone}
              </a>
            </p>
            <p>
