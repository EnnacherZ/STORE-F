...
const Checkout: React.FC = () => {
  ...
  const { serviceableCities: cities, currencies, generateInvoice } = useStoreConfig();
  ...
  const processPayment = async (transactionId: string, date: string) => {
    try {
      ...
      const invoicePdf      = (await generateInvoice(cashPaymentResponse, clientForm, orderedItems)).doc;
