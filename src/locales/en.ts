...
export default {
        translation: {
          ...
          product: {
            ...
            collectionDescription: 'Explore our selected {{type}}, designed for everyday comfort and confident style.',
            ...
            chooseSizeHint: 'Choose a size to continue',
            onlyLeft: '{{count}} available in this size',
          ...
          cart: {
            ...
            addedDrawerDescription: 'This product is now safely in your cart.',
            drawerDescription: 'Review your cart without leaving this page.',
            viewCart: 'View cart',
            ...
            removeItemLabel: 'Remove {{name}} from cart',
          },

          promoCode: {
            label: 'Have a promotion code?', placeholder: 'Enter your code', apply: 'Apply', checking: 'Checking…', remove: 'Remove promotion code', discount: 'Promotion discount', saved: 'You save {{amount}} MAD', required: 'Enter a promotion code.',
            errors: { required: 'Enter a promotion code.', not_found: 'This promotion code does not exist.', inactive: 'This promotion code is inactive.', not_started: 'This promotion has not started yet.', expired: 'This promotion code has expired.', minimum_not_met: 'Your order does not meet the minimum amount for this code.', invalid_cart: 'Your cart could not be validated. Refresh and try again.', invalid: 'This promotion code is not valid.', network: 'The code could not be checked. Please try again.' },
          },
          ...
          payment: {
            ...
            onlineHint: 'Secure online payment',
            secureNote: 'SSL encrypted · Secure checkout',
            completeDetailsFirst: 'Save your delivery details to unlock payment methods.',
            selectMethodPrompt: 'Choose a payment method to continue.',
            initializeError: 'Failed to initialize payment. Please try again.',
            orderError: 'Something went wrong. Please contact support.',
